...
{
    return [self initWithFrame:frame style:kSSCheckBoxViewStyleBox checked:NO];
}
- (id) initWithFrame:(CGRect)frame style:(SSCheckBoxViewStyle)aStyle checked:(BOOL)aChecked
{
    frame.size.height = kHeight;
